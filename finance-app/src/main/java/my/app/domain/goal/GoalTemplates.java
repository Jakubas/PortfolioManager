...
public class GoalTemplates {
	...
	private final static String A = "I want _x_% of my stock in the _y_ sector";
	private final static String B = "I want to move _x_% of my holdings in _y_ to _z_";
	...
	private final static String G = "I want to deposit $_x_ each month and grow my investments to $_y_";
